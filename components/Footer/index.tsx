                ...
                <ul>
                  <li>
                    <a
                      target="_blank"
                      rel="noreferrer"
                      href="https://app.termly.io/policy-viewer/policy.html?policyUUID=adc5508e-3f8c-40b0-86f8-ce0fc5e4bb3a"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                      {" "}
                  ...
                  <li>
                    <a
                      target="_blank"
                      rel="noreferrer"
                      href="https://app.termly.io/policy-viewer/policy.html?policyUUID=a979fea0-7309-4128-9014-fe5ed8ec5409"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                      {" "}
                      Privacy Policy{" "}
