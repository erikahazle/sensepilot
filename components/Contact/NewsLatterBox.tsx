        ...
        <div className="flex flex-col md:flex-row md:gap-4">
            <div className="md:w-1/2 md-pr-1">
              <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
                Join the SensePilot Waitlist
              </h3>
              <p className="mb-11 md:border-b-0 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
                Secure your spot on the SensePilot waitlist today! Sign up to be among the first to experience our cutting-edge digital navigation tools.
                Stay informed about our launch and receive exclusive early access offers. Join us and be a pioneer in the future of accessible computing.
              </p>
            </div>
