              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-full">
                    <List text="Cost-Effective: eliminates the need for high-end, specialized equipment." />
                    <List text="User-Centric: easy installation and user-friendly interface." />
                    <List text="Flexible: ideal for gamers as well as individuals with mobility challenges." />
                  </div>
